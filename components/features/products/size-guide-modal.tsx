            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-black font-heading uppercase tracking-wider text-white">
                  Size Guide & Measurement Diagram
                </h3>
                ...
                <table className="w-full text-left text-xs">
                  <thead className="bg-[#1c1c1c] text-gray-400 uppercase text-[10px] font-black border-b border-[#262626]">
                    <tr>
                      ...
                      <th className="py-2.5 px-3">A: Chest Width ({unit === 'inches' ? 'in' : 'cm'})</th>
                      <th className="py-2.5 px-3">B: Body Length ({unit === 'inches' ? 'in' : 'cm'})</th>
                      <th className="py-2.5 px-3">Height / Weight Fit</th>
                    </tr>
                  </thead>
